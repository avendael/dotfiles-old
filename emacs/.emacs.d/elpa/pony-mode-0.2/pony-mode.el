...
(defvar pony-minor-mode-map
  (let ((map (make-keymap)))
    map))
(pony-key "\C-cPb" 'pony-browser)
(pony-key "\C-cPd" 'pony-db-shell)
(pony-key "\C-cPf" 'pony-fabric)
(pony-key "\C-cPgt" 'pony-goto-template)
(pony-key "\C-cPgs" 'pony-goto-settings)
(pony-key "\C-cPr" 'pony-runserver)
(pony-key "\C-cPm" 'pony-manage)
(pony-key "\C-cPs" 'pony-shell)
(pony-key "\C-cP!" 'pony-shell)
(pony-key "\C-cPt" 'pony-test)
(pony-key "\C-cP\C-r" 'pony-reload-mode)
